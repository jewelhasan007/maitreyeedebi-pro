...
Over a distinguished career spanning more than fifteen years, she has released six acclaimed studio albums, performed in over 400 live grand concerts worldwide, and contributed soul-stirring playback compositions to award-winning cinema and theatrical productions.`,
  ...
  socialLinks: {
    ...
    youtube: "https://www.youtube.com/@MaitreyeeDebiOfficial",
    instagram: "https://www.instagram.com/maitreyee_debi/",
    facebook: "https://facebook.com",
    wikipedia: "https://wikipedia.org",
  },
  agencyContact: {
    management: "Maitreyee Art & Music",
  ...
  developerAgency:{
    developed: "WebMagpie Agency",
    website: "https://webmagpie2026.vercel.app/",
...
export const FEATURED_TRACKS: SongTrack[] = [
  ...
  {
    id: "track-4",
    title: "প্রিয় মা || Priyo Maa - ",
    album: "Celestial Ragas",
    year: 2024,
    duration: "4:44",
    genre: "Classical",
    coverUrl: "/images/featured/priyo-ma.jpg",
    audioUrl: "https://www.youtube.com/watch?v=dxdiXZhJXdI",
    streams: "5",
    featuredArtist: "London Philharmonic Strings",
    lyricsSnippet: "In the quietude of dawn, the soul wakes to the timeless melody of the universe...",
    isPopular: false
  },
  {
    ...
    duration: "3:57",
    genre: "Classical",
    coverUrl: "/images/featured/chuye-dau-jokhon.jpg",
    audioUrl: "https://www.youtube.com/watch?v=dxdiXZhJXdI",
    streams: "5",
    featuredArtist: "London Philharmonic Strings",
    lyricsSnippet: "In the quietude of dawn, the soul wakes to the timeless melody of the universe...",
  ...
  },
  {
    ...
    duration: "4:25",
    genre: "Classical",
    coverUrl: "/images/featured/tumi-nei.jpg",
    audioUrl: "https://www.youtube.com/watch?v=WzG03lYjUpw",
    streams: "123",
    featuredArtist: "London Philharmonic Strings",
    lyricsSnippet: "In the quietude of dawn, the soul wakes to the timeless melody of the universe...",
    isPopular: false
  ...
  {
    id: "track-7",
    title: "সুরের জাদুওয়ালা || Surer Jaduwala - A tribute to Ustad Rashid Khan",
    album: "Celestial Ragas",
    year: 2024,
    duration: "4:46",
    genre: "Classical",
    coverUrl: "/images/featured/surer-jaduwala.jpg",
    audioUrl: "https://www.youtube.com/watch?v=_ev8v5Q5J7s",
    streams: "146",
    featuredArtist: "London Philharmonic Strings",
    lyricsSnippet: "In the quietude of dawn, the soul wakes to the timeless melody of the universe...",
    isPopular: false
  ...
  {
    id: "track-8",
    title: "কত যত্নে রেখেছিলাম || Koto jotne rekhesilam",
    album: "Celestial Ragas",
    year: 2024,
    duration: "4:46",
    genre: "Classical",
    coverUrl: "/images/featured/koto-jotne-rekhesilam.jpg",
    audioUrl: "https://www.youtube.com/watch?v=60hWWZlBvPA",
    streams: "146",
    featuredArtist: "London Philharmonic Strings",
    lyricsSnippet: "In the quietude of dawn, the soul wakes to the timeless melody of the universe...",
    isPopular: false
  ...
  {
    id: "track-8",
    title: "এই নীল মণিহার || Ei nil monihar",
    album: "Celestial Ragas",
    year: 2024,
    duration: "5:36",
    genre: "Classical",
    coverUrl: "/images/featured/ei-nil-monihar.jpg",
    audioUrl: "https://www.youtube.com/watch?v=3atvyqU4LaY",
    streams: "19",
    featuredArtist: "London Philharmonic Strings",
    lyricsSnippet: "In the quietude of dawn, the soul wakes to the timeless melody of the universe...",
    isPopular: false
